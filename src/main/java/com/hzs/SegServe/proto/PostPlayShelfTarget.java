...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return CampaignProto.internal_static_PostPlayShelfTarget_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            PostPlayShelfTarget.class, PostPlayShelfTarget.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof PostPlayShelfTarget)) {
      return super.equals(obj);
    }
    PostPlayShelfTarget other = (PostPlayShelfTarget) obj;
  ...
  public static PostPlayShelfTarget parseFrom(
  ...
  public static PostPlayShelfTarget parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static PostPlayShelfTarget parseFrom(
  ...
  public static PostPlayShelfTarget parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static PostPlayShelfTarget parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static PostPlayShelfTarget parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(PostPlayShelfTarget prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using PostPlayShelfTarget.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public PostPlayShelfTarget getDefaultInstanceForType() {
      return PostPlayShelfTarget.getDefaultInstance();
    }

    @java.lang.Override
    public PostPlayShelfTarget build() {
      PostPlayShelfTarget result = buildPartial();
    ...
    @java.lang.Override
    public PostPlayShelfTarget buildPartial() {
      PostPlayShelfTarget result = new PostPlayShelfTarget(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(PostPlayShelfTarget result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof PostPlayShelfTarget) {
        return mergeFrom((PostPlayShelfTarget)other);
      } else {
    ...
    public Builder mergeFrom(PostPlayShelfTarget other) {
      if (other == PostPlayShelfTarget.getDefaultInstance()) return this;
  ...
  private static final PostPlayShelfTarget DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new PostPlayShelfTarget();
  }

  public static PostPlayShelfTarget getDefaultInstance() {
