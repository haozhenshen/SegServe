...
private static final long serialVersionUID = 0L;
  ...
  public static final int RES_TEST_FIELD_NUMBER = 1;
  private volatile java.lang.Object resTest_;
  /**
   * <code>string res_test = 1;</code>
   * @return The resTest.
   */
  public java.lang.String getResTest() {
    java.lang.Object ref = resTest_;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getResTestBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 1, resTest_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!getResTestBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1, resTest_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getResTest()
        .equals(other.getResTest())) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + RES_TEST_FIELD_NUMBER;
    hash = (53 * hash) + getResTest().hashCode();
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.hzs.grpc_service.model.UserResponse other) {
      ...
      if (!other.getResTest().isEmpty()) {
        resTest_ = other.resTest_;
        onChanged();
      }
    ...
    private java.lang.Object resTest_ = "";
    /**
     * <code>string res_test = 1;</code>
     * @return The resTest.
     */
    ...
    /**
     * <code>string res_test = 1;</code>
     * @param value The resTest to set.
     * @return This builder for chaining.
     */
    public Builder setResTest(
     ...
     * @return This builder for chaining.
     */
    public Builder clearResTest() {
      
      resTest_ = getDefaultInstance().getResTest();
      onChanged();
      return this;
    }
    /**
     * <code>string res_test = 1;</code>
     * @param value The bytes for resTest to set.
     * @return This builder for chaining.
     */
    public Builder setResTestBytes(
