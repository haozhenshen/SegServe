...
public final class CampaignServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.hzs.grpc_service.proto.CampaignService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.hzs.grpc_service.proto.UserRequest,
      com.hzs.grpc_service.proto.UserResponse> getGetUserCampaignsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserCampaigns",
      requestType = com.hzs.grpc_service.proto.UserRequest.class,
      responseType = com.hzs.grpc_service.proto.UserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hzs.grpc_service.proto.UserRequest,
      com.hzs.grpc_service.proto.UserResponse> getGetUserCampaignsMethod() {
    io.grpc.MethodDescriptor<com.hzs.grpc_service.proto.UserRequest, com.hzs.grpc_service.proto.UserResponse> getGetUserCampaignsMethod;
      ...
      synchronized (CampaignServiceGrpc.class) {
        if ((getGetUserCampaignsMethod = CampaignServiceGrpc.getGetUserCampaignsMethod) == null) {
          CampaignServiceGrpc.getGetUserCampaignsMethod = getGetUserCampaignsMethod =
              io.grpc.MethodDescriptor.<com.hzs.grpc_service.proto.UserRequest, com.hzs.grpc_service.proto.UserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUserCampaigns"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hzs.grpc_service.proto.UserRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hzs.grpc_service.proto.UserResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getUserCampaigns(com.hzs.grpc_service.proto.UserRequest request,
        io.grpc.stub.StreamObserver<com.hzs.grpc_service.proto.UserResponse> responseObserver) {
  ...
  public static final class CampaignServiceStub
    ...
    /**
     */
    public void getUserCampaigns(com.hzs.grpc_service.proto.UserRequest request,
        io.grpc.stub.StreamObserver<com.hzs.grpc_service.proto.UserResponse> responseObserver) {
  ...
  public static final class CampaignServiceBlockingStub
    ...
    /**
     */
    public com.hzs.grpc_service.proto.UserResponse getUserCampaigns(com.hzs.grpc_service.proto.UserRequest request) {
  ...
  public static final class CampaignServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hzs.grpc_service.proto.UserResponse> getUserCampaigns(
        com.hzs.grpc_service.proto.UserRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER_CAMPAIGNS:
          serviceImpl.getUserCampaigns((com.hzs.grpc_service.proto.UserRequest) request,
              (io.grpc.stub.StreamObserver<com.hzs.grpc_service.proto.UserResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.hzs.grpc_service.proto.UserRequest,
              com.hzs.grpc_service.proto.UserResponse>(
  ...
  private static abstract class CampaignServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hzs.grpc_service.proto.CampaignProto.getDescriptor();
    }
